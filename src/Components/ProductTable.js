...
const rows = [
    ...
    {id: 'quantity', numeric: true, disablePadding: false, label: 'Quantity (Unit)'},
    {id: 'ratio', numeric: true, disablePadding: false, label: 'Ratio (€/Unit)'},
];
            ...
            <div className={classes.actions}>
                ...
                <Tooltip title="Delete">
                    <IconButton aria-label="Delete"
                                onClick={() => {
                                    props.deleteSelectedProductHandler();
                                }}>
                        <DeleteIcon/>
                    </IconButton>
                </Tooltip>
...
class ProductTable extends Component {
    ...
    handleSelectAllClick = event => {
        if (event.target.checked) {
            ...
            newState["selected"] = this.props.rows.map(n => n.id);
    ...
    handleDeleteSelection = (selected) => () => {
        this.props.deleteProductHandler(selected);
        this.setState({selected: []});
        return;
    }
        ...
        return (
            <Paper className={classes.root}>
                <ProductTableToolbar numSelected={selected.length}
                                     deleteSelectedProductHandler={this.handleDeleteSelection(selected)}/>
                                ...
                                .map(n => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell numeric>{n.ratio}</TableCell>
                                        </TableRow>
                                    );
                                })}
                            {emptyRows > 0 && (
